describe('Dependency injection (standalone)', function () {
  ...
  it ('can resolve a simple application lazily', function () {
  ...
  it ('can resolve a simple app lazily and provide afterwards', function () {
    var _server = new Di('TransporterServer', true);
    ...
    // _server.resolve();
    assert.ok(_server.provided);
    // assert.ok(_.isFunction(_server.provided));
  })
